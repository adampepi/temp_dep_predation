...
predprey_equations_DD_JD  <- function(t, y, parms) {
  a=parms[1]; c=parms[2] ; m= parms[3]; b=parms[4]; g=parms[5]; n=parms[6];o=parms[7]; K=parms[9];h=parms[8];
...
stability(Abar=14.81482,Pbar=14.17010,Jbar=11.1111110,parms=parms,eigenv=TRUE)
